...
// ArubaBlockStorageSpec defines the desired state of ArubaBlockStorage.
type ArubaBlockStorageSpec struct {
...
// ArubaBlockStorageStatus defines the observed state of ArubaBlockStorage.
type ArubaBlockStorageStatus struct {
...
// +kubebuilder:resource:scope=Namespaced,shortName=abs
...
// ArubaBlockStorage is the Schema for the arubablockstorages API.
type ArubaBlockStorage struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   ArubaBlockStorageSpec   `json:"spec,omitempty"`
	Status ArubaBlockStorageStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ArubaBlockStorageList contains a list of ArubaBlockStorage.
type ArubaBlockStorageList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ArubaBlockStorage `json:"items"`
}

func init() {
	SchemeBuilder.Register(&ArubaBlockStorage{}, &ArubaBlockStorageList{})
}
